...
pub struct Repository {
    ...
    /// Normalized domain for the repository's primary platform
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub domain: Option<String>,

    /// Reference to a unified identity across platforms
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub unified_owner_id: Option<String>,

    /// Which seed user first discovered this repository
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
"#;
        let repo: Repository =
            serde_yml::from_str(yaml).expect("should deserialize without relations");
