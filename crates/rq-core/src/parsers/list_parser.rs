...
mod tests {
    ...
    fn test_quality_score_calculation() {
        ...
        assert_eq!(
            QualityMetrics::calculate_score(5, false, false, false, false),
            0
        );

        // Medium stars with description
        assert_eq!(
            QualityMetrics::calculate_score(500, false, true, false, false),
            28
        );

        // High stars, not archived
        assert_eq!(
            QualityMetrics::calculate_score(10000, false, false, false, false),
            75
        );

        // High stars but archived
        assert_eq!(
            QualityMetrics::calculate_score(10000, false, false, false, true),
            55
        );
    }
