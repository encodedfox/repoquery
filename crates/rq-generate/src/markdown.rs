...
mod tests {
    ...
    fn test_repo(id: &str, lang: &str, stars: u32) -> rq_core::Repository {
        rq_core::Repository {
            id: id.to_string(),
    ...
    fn test_generate_list_markdown() {
        ...
        let output = gen
            .generate_list(&data, false)
            .expect("generate_list failed");
    ...
    fn test_generate_table_markdown() {
        ...
        let data = active_data();
        let output = gen
            .generate_table(&data, false)
            .expect("generate_table failed");
    ...
    fn test_generate_list_for_collection() {
        ...
        let output = gen
            .generate_list_for_collection(
                &repos,
                "My Rust Collection",
                Some("Best Rust repos"),
                false,
            )
